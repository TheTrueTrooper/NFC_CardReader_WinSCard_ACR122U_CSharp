...
{
    public class Block16ApplicationDirectory : Block16
    {
        public Block16ApplicationDirectory(BaseSector BaseSectorIn) : base(BaseSectorIn, Block16SubTypes.ApplicationDirectory, true)
        {}
        ...
        [Obsolete("Code is not obsolete; however, it is unsafe. Wrtting to this location could change or damage your cards Application behavior.")]
